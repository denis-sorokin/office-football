			...
			<div class="row">
				<div class="col-10 offset-1">
					...
					<div class="form-group mt-5 wp-max-content mx-auto pr-5">
                        ...
                        type: 'text', validFeedback: 'Only chars and numbers', required: true }"
                        @change="updateUsername"></v-input>
						<v-input :data="{
                        name: 'email', label: $t('auth.email'), valid: validateEmail,
                        type: 'text', validFeedback: 'char.-+char@email.com', required: true }"
                        @change="updateEmail"></v-input>
						<v-input :data="{
